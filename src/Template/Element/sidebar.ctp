<div class="sidebar" data-color="purple" data-image="../assets/img/sidebar-1.jpg">
    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <?php if($listProjectManager != array()) { ?>
                <li>
                    ...
                    <div class="collapse" id="manageTask" >
                        <ul class="nav">
                            <?php foreach($listProjectManager as $project) { ?>
                                <li>
                                    <a data-toggle="collapse" href="#project<?= $project->Projects['id'] ?>">
                                        <p> <?= $project->Projects['name'] ?>
                                            <b class="caret"></b>
                                        </p>
                                    </a>
                                    <div class="collapse" id="project<?= $project->Projects['id'] ?>" >
                                        <ul class="nav">
                                            <li>
                                                <a href="/tasks/listTaskOfProjectId/<?= $project->Projects['id'] ?>">
                                                    <span class="sidebar-normal"> Danh sách nhiệm vụ</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="/tasks/add/<?= $project->Projects['id'] ?>">
                                                    <span class="sidebar-normal"> Thêm mới nhiệm vụ</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="/UserProjects/index/<?= $project->Projects['id'] ?>">
